...
/// <summary>Keycloak token endpoint — password grant and client_credentials. Base URL: /realms/{realm}.</summary>
public interface IKeycloakTokenClient
{
    /// <summary>client_credentials grant — used for the Admin API service account.</summary>
    ...
    /// <summary>Password grant — used to obtain individual user tokens.</summary>
    [Post("/protocol/openid-connect/token")]
