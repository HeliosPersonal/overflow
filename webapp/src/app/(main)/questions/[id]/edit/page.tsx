...
export default async function EditQuestionPage({params}: {params: Params}) {
    ...
    if (error) {
        return (
            <div className='min-h-full bg-content1 flex flex-col gap-4 px-3 sm:px-6 pt-4'>
    ...
    return (
        <div className='min-h-full bg-content1 flex flex-col gap-4 px-3 sm:px-6 pt-4 pb-6'>
            <h1>Edit your question</h1>
