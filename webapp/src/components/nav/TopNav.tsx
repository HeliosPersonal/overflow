...
export default async function TopNav() {
    ...
    return (
        <header className='h-14 w-full fixed top-0 z-50 bg-content1 shadow-raise-sm'>
            <div className='flex items-center h-full px-3 sm:px-4 mx-auto'>
                <div className='flex items-center gap-3 sm:gap-6'>
                    <Link href='/' className='flex items-center gap-2 sm:gap-3 max-h-16'>
                        <Layers size={40} className='text-primary' />
                        <h3 className='text-xl font-semibold uppercase hidden sm:block'>Overflow</h3>
                    </Link>
                </div>
